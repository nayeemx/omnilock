...
export function Field({ label, icon: Icon, children }: { label: string; icon: React.ElementType; children: React.ReactNode }) {
  return (
    <label className="block">
      ...
      <div className="flex items-center gap-2 px-3 py-2.5 rounded-lg bg-surface border border-surface-border focus-within:border-[color:var(--primary)]/50 transition-colors">
